<?php
/**
 * Radix DLT functions and definitions
 *
...
if ( ! function_exists( 'radix_setup' ) ) :
	...
	function radix_setup() {
		 ...
		 * If you're building a theme based on Radix DLT, use a find and replace
		 * to change 'radix' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'radix', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'radix' ),
		) );
...
function radix_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'radix_content_width', 640 );
}
add_action( 'after_setup_theme', 'radix_content_width', 0 );
...
function radix_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'radix' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'radix' ),
